...
public class AOC2025
{
    ...
    [Fact]
    public void Day08A() => Assert.Equal(69192, new Day08A().Test());
    
    [Fact]
    public void Day08B() => Assert.Equal(7264308110, new Day08B().Test());
    ...
    // [Fact]
    // public void Day10B() => Assert.Equal(401, new Day10B().Test());
    
    [Fact]
    public void Day11A() => Assert.Equal(523, new Day11A().Test());
    
    [Fact]
    public void Day11B() => Assert.Equal(517315308154944, new Day11B().Test());
    
    [Fact]
    public void Day12A() => Assert.Equal(569, new Day12A().Test());
}
